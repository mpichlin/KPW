...
public:
    ...
    void setupUi(QWidget *edytor)
    {
        ...
        new QListWidgetItem(ukryteQlista);
        ...
        alternatywneQlista->setSortingEnabled(true);
    ...
    {
        edytor->setWindowTitle(QApplication::translate("edytor", "Edytor poj\304\231c", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("edytor", "termin preferowany:", 0, QApplication::UnicodeUTF8));

        const bool __sortingEnabled = ukryteQlista->isSortingEnabled();
        ukryteQlista->setSortingEnabled(false);
        QListWidgetItem *___qlistwidgetitem = ukryteQlista->item(0);
        ___qlistwidgetitem->setText(QApplication::translate("edytor", "Nowy element", 0, QApplication::UnicodeUTF8));
        ukryteQlista->setSortingEnabled(__sortingEnabled);


        const bool __sortingEnabled1 = alternatywneQlista->isSortingEnabled();
        alternatywneQlista->setSortingEnabled(false);
        QListWidgetItem *___qlistwidgetitem1 = alternatywneQlista->item(0);
        ___qlistwidgetitem1->setText(QApplication::translate("edytor", "Nowy element", 0, QApplication::UnicodeUTF8));
        alternatywneQlista->setSortingEnabled(__sortingEnabled1);
